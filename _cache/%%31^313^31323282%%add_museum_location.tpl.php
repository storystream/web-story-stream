<?php /* Smarty version 2.6.21, created on 2013-04-03 09:59:36
         compiled from boxes/add_museum_location.tpl */ ?>
<body class="panel">
<div id="bg">
<div id="container">
	...
	<div id="panel">
		...
		<form action="add_museum_location.php?ACT=add" id="add" name="add" method="post" enctype="multipart/form-data">
