<?php /* Smarty version 2.6.21, created on 2013-04-12 06:54:18
         compiled from boxes/edit_museum_category.tpl */ ?>
...
?>   
	  <form action="edit_museum_category.php?ACT=edit" id="add" name="add" method="post" enctype="multipart/form-data">
  	<div id="container">
  		<div id="top" class="logged">
  			<ul id="top-panel-tools">
  				<li><a onclick="document.add.submit();return false;">Zapisz muzeum</a></li>
